...
%===============================
\begin{description}
  \item[-] Estus H. and Vashti L. Magoon Research Excellence Award 2025
  \item[-] Bilsland Dissertation Fellowship 2025
...
\begin{description}
    \item \textbf{Jha S}. and Krogmeier J. V.. Advancing Meter Resolution Crop Simulation Model as a Testbed for Precision Agricultural Applications. Conference on Agrifood and Electronics (CAFE 2025), Montevideo, Uruguay. DOI: 10.36227/techrxiv.175612861.18484359/v1
    
    \item 2500667.  Jha, S., Krogmeier, J. V., and Zhang, Y. (2025). Leveraging high-resolution geospatial data for systematic blocking in precision agricultural experiments. Presented at ASABE Annual International Meeting, 13-16th July, Toronto, Canada.
